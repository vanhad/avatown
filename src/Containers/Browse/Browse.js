...
const Browse = props => {
  const { 
    ...
    useEffect(() => {
      if (currentFilter == "none") {
      ...
      } else if (currentFilter != "Ratings" && currentFilter != "Reviews" && currentFilter != "Wishlist" && currentFilter != "Price" && currentFilter != "Price15" && currentFilter != "Price25"&& currentFilter != "Price35" && currentFilter != "Price45") {
        ...
        let filteredShownGames = allGames.filter(game => parseInt(game.price) <= 10);
        setShownGames(filteredShownGames);
      }else if (currentFilter === "Price15") {
        console.log("inside15")
      let filteredShownGames = allGames.filter(game => (parseInt(game.price) > 10 && parseInt(game.price) <= 20));
      setShownGames(filteredShownGames);
      }else if (currentFilter === "Price25") {
        let filteredShownGames = allGames.filter(game => (parseInt(game.price) > 20 && parseInt(game.price) <= 30));
        setShownGames(filteredShownGames);
        }else if (currentFilter === "Price35") {
          let filteredShownGames = allGames.filter(game => (parseInt(game.price) > 30 && parseInt(game.price) <= 40));
          setShownGames(filteredShownGames);
        }else if (currentFilter === "Price45") {
          let filteredShownGames = allGames.filter(game => parseInt(game.price) > 40 );
          setShownGames(filteredShownGames);
        }
      //   else if (currentFilter === "Price55") {
      //   let filteredShownGames = allGames.filter(game => (parseInt(game.price) > 50 && parseInt(game.price) <= 60));
      //   setShownGames(filteredShownGames);
      //   }else if (currentFilter === "Price65") {
      //   let filteredShownGames = allGames.filter(game => (parseInt(game.price) > 60 && parseInt(game.price) <= 70));
      //   setShownGames(filteredShownGames);
      //   }else if (currentFilter === "Price75") {
      //     let filteredShownGames = allGames.filter(game => parseInt(game.price) > 70);
      //     setShownGames(filteredShownGames);
      // }
