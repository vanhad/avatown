                ...
                <div className={styles.container}>
                    <div className={styles.left}>
                        ...
                        <div className={styles.buttons}>
                              ...
                              <a href="" target="_blank"><button className={styles.cta} aria-label="View Repository">
                                <GitHubLogo className={styles.ctaSVG} />
                                GitHub
                              </button></a>
                              <a href="" target="_blank"><button className={`${styles.cta} ${styles.lastChild}`} aria-label="Open LinkedIn">
                    ...
                    <div className={styles.right}>
                        <div className={styles.buttonsRight}>
                            ...
                            <a href='' target="_blank"><button className={styles.cta} aria-label="Open commit log">
                            ...
                            <a href="" target="_blank"><button className={`${styles.cta} ${styles.lastChild}`} aria-label="View Sources">
