...
import img from './Dollar_Sign.svg.png'
// import { ReactComponent as Price } from "../../Resources/image/price.svg";
          ...
          <div 
               ...
               >
                 <button 
                   ...
                   style={{ backgroundColor: (hoverState[19].hovered || currentFilter == "Price") ? "#fff" : "#2d2d2d"  }}
                   aria-label="Open Price"
                 >
                     <img src= {img}
                        style={{ fill: (hoverState[19].hovered || currentFilter == "Price") ? "#000000" : "#fff"}} 
               ...
               >
                 <button 
                   className={styles.filterBtn} 
                   style={{ backgroundColor: (hoverState[20].hovered || currentFilter == "Price15") ? "#fff" : "#2d2d2d"  }}
                   aria-label="Open Price"
                 >
                     <img src= {img}
                        style={{ fill: (hoverState[20].hovered || currentFilter == "Price15") ? "#000000" : "#fff"}} 
                        className={styles.Price}
                     />
                 </button>
                 10$ to 20$
               ...
               >
                 <button 
                   className={styles.filterBtn} 
                   style={{ backgroundColor: (hoverState[21].hovered || currentFilter == "Price25") ? "#fff" : "#2d2d2d"  }}
                   aria-label="Open Price"
                 >
                     <img src= {img}
                        style={{ fill: (hoverState[21].hovered || currentFilter == "Price25") ? "#000000" : "#fff"}} 
                        className={styles.Price}
                     />
                 </button>
                 20$ to 30$
               ...
               >
                 <button 
                   className={styles.filterBtn} 
                   style={{ backgroundColor: (hoverState[22].hovered || currentFilter == "Price35") ? "#fff" : "#2d2d2d"  }}
                   aria-label="Open Price"
                 >
                     <img src= {img}
                        style={{ fill: (hoverState[22].hovered || currentFilter == "Price35") ? "#000000" : "#fff"}} 
                        className={styles.Price}
                     />
                 </button>
                 30$ to 40$
               ...
               >
                 <button 
                   className={styles.filterBtn} 
                   style={{ backgroundColor: (hoverState[23].hovered || currentFilter == "Price45") ? "#fff" : "#2d2d2d"  }}
                   aria-label="Open Price"
                 >
                     <img src= {img}
                        style={{ fill: (hoverState[23].hovered || currentFilter == "Price45") ? "#000000" : "#fff"}} 
                        className={styles.Price}
                     />
                 </button>
                 40$ and above
               ...
               >
                 <button 
                   className={styles.filterBtn} 
                   style={{ backgroundColor: (hoverState[24].hovered || currentFilter == "Price55") ? "#fff" : "#2d2d2d"  }}
                   aria-label="Open Price"
                 >
                     <img src= {img}
                        style={{ fill: (hoverState[24].hovered || currentFilter == "Price55") ? "#000000" : "#fff"}} 
                        className={styles.Price}
                     />
                 </button>
                 50$ to 60$
               ...
               >
                 <button 
                   className={styles.filterBtn} 
                   style={{ backgroundColor: (hoverState[25].hovered || currentFilter == "Price65") ? "#fff" : "#2d2d2d"  }}
                   aria-label="Open Price"
                 >
                     <img src= {img}
                        style={{ fill: (hoverState[25].hovered || currentFilter == "Price65") ? "#000000" : "#fff"}} 
                        className={styles.Price}
                     />
                 </button>
                 60$ to 70$
               ...
               >
                 <button 
                   className={styles.filterBtn} 
                   style={{ backgroundColor: (hoverState[26].hovered || currentFilter == "Price75") ? "#fff" : "#2d2d2d"  }}
                   aria-label="Open Price"
                 >
                     <img src= {img}
                        style={{ fill: (hoverState[26].hovered || currentFilter == "Price75") ? "#000000" : "#fff"}} 
                        className={styles.Price}
                     />
                 </button>
                 70$ and above
