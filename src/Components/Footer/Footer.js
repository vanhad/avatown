        ...
        <div className={styles.footer}>
            ...
            <div className={styles.footerInfo}>
              <div className={styles.infoLeft}>
                <p>This page was built by Vuppuluri Anhad with React.</p>
                <p>Portions of this page are inspired by <span></span>. This page was built solely for educational purposes.</p>
              </div>
